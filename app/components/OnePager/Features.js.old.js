...
class Features extends React.Component {
	...
	render() {
		...
		if(timeStatus == 'Fajr'){
			styleFeatures = cssFajar.features(this.props.arabic);
		}else{
			styleFeatures = cssMaghrib.features(this.props.arabic);

		}

		return (
			<InlineCss namespace="features" stylesheet={styleFeatures}>
